...
final agent:Agent _personalAiAssistantAgent = check new (
    systemPrompt = {
...
- Prioritize clarity, efficiency, and user convenience in all tasks.`
    }, model = _personalAiAssistantModel, tools = [sendEmail, getCalanderEvents, createCalanderEvent, getCurrentDate]
);
